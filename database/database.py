...
class DataBase:
    ...
    def change_username_by_telegram_id(self, telegram_id):
        sql = '''
    ...
    def delete_admin(self, telegram_id):
        sql = '''
            DELETE FROM admin_list WHERE telegram_id = ?
        '''
        self.manager(sql, telegram_id, commit=True)

    def get_admin(self, telegram_id):
        sql = '''
            SELECT * FROM admin_list WHERE telegram_id = ?
        '''
        return self.manager(sql, telegram_id, fetchone=True)
    ...
    def remove_ban_user(self, telegram_id):
        sql = '''
            DELETE FROM ban_list WHERE telegram_id = ?
        '''
        self.manager(sql, telegram_id, commit=True)
    ...
    def add_chat(self, first_telegram_id, second_telegram_id, date):
        sql = '''
            INSERT INTO chats(first_telegram_id, second_telegram_id, date) VALUES(?,?,?)
        '''
    ...
    def add_chat_message(self, chat_id, telegram_id, message_text, date):
        sql = '''
            INSERT INTO chat_messages(chat_id, telegram_id, message_text, date) VALUES(?,?,?,?)
        '''
